        ...
        <div className="w-full max-w-7xl mx-auto my-10 ">
            <div className="flex items-center gap-8">
                ...
                <div className="text-left">
                    ...
                    <Button variant="secondary" className="!py-1 !mt-4 !w-fit !rounded-full">
                        Edit Profile
                    </Button>
                </div>
            </div>
            ...
            {/* phone no & address */}
            <div className="shadow-[5px_5px_20px_rgba(0,0,0,0.15)] py-2 rounded-lg my-10">
...
const OrderCard = ()=>{
    return(
        <div className="shadow-[5px_5px_20px_rgba(0,0,0,0.15)] p-2 rounded-md w-[350px]">
            <div className="grid grid-cols-3 gap-2 bg-gray-200 rounded-sm p-1 px-2">
